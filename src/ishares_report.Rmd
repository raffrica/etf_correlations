...
![Selection of NAV Time Cut-Off](../results/ishares_nav_3_year.png)



![Distribution of NAVs Compared to S&P500](../results/ishares_hist_etfs.png)


![Distribution of Correlations](../results/ishares_corr_hist.png)
